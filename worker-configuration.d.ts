/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bea74293f54589f21c2fdce62a95a1fe)
// Runtime types generated with workerd@1.20260603.1 2025-10-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	VITE_BASE_URL: string;
	VITE_DODO_CHECKOUT_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_BASE_URL" | "VITE_DODO_CHECKOUT_URL" | "DODO_PAYMENTS_API_KEY" | "DODO_WEBHOOK_KEY" | "DODO_PRODUCT_ID" | "DODO_ENVIRONMENT" | "BETTER_AUTH_SECRET" | "LICENSE_PRIVATE_KEY_HEX" | "LICENSE_ADMIN_SECRET" | "GITHUB_TOKEN" | "PLUNK_API_KEY" | "DODO_TEAM_PRODUCT_ID">> {}
}
